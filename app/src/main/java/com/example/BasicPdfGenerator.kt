...
fun generateBasicCertificatePdf(
    context: Context,
    name: String,
    seatNo: String,
    gov: String,
    ...
    drawTextRight(canvas, "مصدر البيانات:   نظام كشوف الاستعلام لطلاب مرحلة التعليم الأساسي المعتمد", colRightX, infoY + 60f, 490, 8.5f, 0xFF64748B.toInt(), isBold = false)
    ...
    // Subjects list for basic education
    val subjects = listOf(
        ...
        Pair("science", R.string.sub_science),
        Pair("social", R.string.sub_social)
    )
    ...
    // 7. Results Dashboard Summary Box (Pale yellow background as requested: "خلفية صفراء باهتة")
    ...
    val arabicTotalValue = formatToArabicIndicDigits(totalSum.toString()) + " / " + formatToArabicIndicDigits("700")
    ...
    val filename = "Shahadati_Basic_${seatNo}.pdf"
